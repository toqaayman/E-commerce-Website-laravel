    ...
    {{---------------------
        ...
        <div class="_container">
            ...
            <form class="card" action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
                ...
                New? : <input type="checkbox" name="new" class="switch-input" value="1" {{ old('new') ? 'checked="checked"' : '' }}/><br><br>

                Product info: <input type="text" name="about" value="{{ old('about') }}" required placeholder="Product info"><br><br>
                Product Manufacturer: <input type="text" name="Manufacturer" value="{{ old('Manufacturer') }}" required placeholder="Manufacturer name"><br><br>
